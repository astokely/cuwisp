...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cfrechet

#else
#  define SWIG_init    init_cfrechet

#endif
#define SWIG_name    "_cfrechet"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_cFrechet(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "cFrechet", 5, 5, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "cFrechet" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = (int)(val7);
  ecode8 = SWIG_AsVal_int(swig_obj[4], &val8);
  if (!SWIG_IsOK(ecode8)) {
    SWIG_exception_fail(SWIG_ArgError(ecode8), "in method '" "cFrechet" "', argument " "8"" of type '" "int""'");
  } 
  arg8 = (int)(val8);
  result = (double)cFrechet(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cFrechet", _wrap_cFrechet, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
